...
var AppComponent = (function () {
    function AppComponent(data, userResponse) {
        ...
        this.testingParameter = true; // if this is true then a hardcoded case will show for testing
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.data.getQuestions().subscribe(function (response) {
            ...
            //Step 7: Get the type of Visual Encoding
            _this.currentEncoding = _this.questions[_this.randomizedQuestionOrder[_this.currentQuestionCounter] - 1].visualEncoding;
            _this.padding = _this.returnPadding(_this.currentEncoding);
        });
    };
    ...
    AppComponent.prototype.loadNextQuestion = function () {
        if (this.currentQuestionCounter < this.totalQuestionCounter - 1) {
            ...
            //Step 7: Get the type of Visual Encoding
            this.currentEncoding = this.questions[this.randomizedQuestionOrder[this.currentQuestionCounter + 1] - 1].visualEncoding;
            this.padding = this.returnPadding(this.currentEncoding);
    ...
    AppComponent.prototype.returnPadding = function (encoding) {
        if (encoding == "circle") {
            return "27";
        }
        else if (encoding == "spiral") {
            return "27";
        }
        else {
            return "0";
    ...
    AppComponent.prototype.saveData = function () {
        ...
        this.userResponseLocalVar.duration = ((this.userResponseLocalVar.endTime.getTime() - this.userResponseLocalVar.startTime.getTime()) / 1000);
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_5" /* HostListener */])('document:keypress', ['$event']),
...
AppComponent = __decorate([
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_5" /* HostListener */])('window:resize', ['$event']),
